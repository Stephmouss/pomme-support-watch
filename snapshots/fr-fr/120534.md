# Formats RAW d’appareils photo numériques compatibles avec iOS 18, iPadOS 18, macOS Sequoia et visionOS 2
...
Cette liste est à jour au mois de juillet 2025 et indique la compatibilité avec les dernières versions d’iOS 18, d’iPadOS 18, de macOS Sequoia 15 et de visionOS 2. Ces systèmes d’exploitation comprennent un système de gestion avancé pour le traitement des formats RAW d’appareils photo numériques, pour des images plus détaillées, une réduction du bruit optimisée et une plus grande souplesse en matière de retouche d’images avec des apps prenant en charge le format RAW. Ils offrent également une gestion de base des fichiers RAW au format DNG (Digital Negative), même lorsque ceux-ci proviennent d’appareils photo non répertoriés ici.

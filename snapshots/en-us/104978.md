...
- Select the lost device or item to find it on a map. Tap the More button , then:

- Choose Directions to open its location in Maps.

- If you're close, tap Play (Play Sound).

- If your iPhone has Ultra Wideband, [tap Find (Find Nearby)](https://support.apple.com/en-us/109021) to show the distance and direction to your AirTag or AirPods Pro 2 or later.

[Image: Find My app showing an arrow that indicates which way to look for a nearby lost item, along with distance and direction.]

You can also [find your devices at icloud.com/find](https://support.apple.com/guide/icloud/mmfc0f2442/) . To locate AirTag and Find My network accessories, you can only use the Find My app on iPhone, iPad, Mac, or Apple Watch.
...
- Tap the More button , then scroll down to the section labeled "Lost [device]" or "Lost [item]."
...
[Image: iPhone screen showing the Lost Mode confirmation screen, with fields for custom message and phone number, an option to Receive Email Updates, and an Activate button.]
...
Before you erase your device, make sure that you try everything else. Erasing your device can't be undone.

### Erase a device in Find My

- In the Find My app, choose Devices.

- Select your lost device, then tap the More button .

...
[Image: Alert message stating "Apple cannot check 'Example App' for malicious software" with options to "Move to Trash" or "Done".]
...
- If you’re certain that the app is from a trustworthy source and hasn’t been tampered with, [you might be able to temporarily override your Mac security settings to open it](https://support.apple.com/en-us/102445#openanyway)
...
- [Change your Privacy & Security Settings to allow apps downloaded from both the App store and identified developers](https://support.apple.com/en-us/102445#changesettings)

### Alert that the app will damage your computer or the app is damaged

[Image: An alert that an app containing malware was blocked from opening and has been moved to Trash. You might be asked to send a copy of the malware to Apple.]
...
[Image: Screenshot of macOS System Settings > Privacy & Security panel, highlighting the "Open Anyway" button for overriding security warnings.]

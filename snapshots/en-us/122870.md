...
This list is current as of September 2026 and reflects compatibility with the latest versions of iOS 26, iPadOS 26, macOS Tahoe 26, and visionOS 26. These operating systems include enhanced support for processing digital camera RAW formats, providing better detail, improved noise reduction, and greater image-editing flexibility when using apps that support RAW. They also include basic support for RAW files in DNG (Digital Negative) format when captured by these and other cameras.
...
- Lossless compressed format only
